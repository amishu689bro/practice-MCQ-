...
export const unit1Quiz2: Quiz = {
  id: "computer-networks-unit-1-quiz-2",
  title: "Computer Networks",
  subject: "Computer Networks",
  unit: "Unit 1 · Quiz 2",
  description:
    "Network characteristics (redundancy, scalability, security), topologies, devices & OSI layers, data units and TCP/IP — 50 more MCQs (Q51–Q100) with detailed English + Hinglish explanations and memory tricks.",
  topics: [
    "Network Concepts",
    "Topologies",
    "Devices & Layers",
